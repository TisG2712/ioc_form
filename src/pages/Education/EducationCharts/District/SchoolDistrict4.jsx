...
function SchoolDistrict4({ filters }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (Array.isArray(response) && response.length > 0) {
          const filteredData = response
            ...
            .map(item => ({
              ...
              value: parseFloat((item.siSoTrungBinh || 0).toFixed(1))
            }));
        ...
        console.error("Error fetching data for SchoolDistrict4:", error);
      } finally {
        setIsLoading(false);
      }
    };
  ...
  return (
    <div className="w-full">
      <h2 className="text-[10px] sm:text-xs font-medium mb-2 sm:mb-3 text-center px-2">
        Sĩ số trung bình theo quận/huyện
      </h2>
      <ResponsiveContainer width="100%" height={190}>
        ...
        >
          ...
          <Tooltip 
            ...
            formatter={(value) => [value, 'Học sinh/lớp']} 
          />
...
export default SchoolDistrict4;
